...
const sampleTweets = [
    {
        ...
        handle: "@siphok",
        avatar: "https://ui-avatars.com/api/?name=Sipho+Khumalo&background=1DA1F2&color=fff&size=48",
        text: "Finally launched a move in Europe! Can’t wait for everyone to see the South African sensation at Belgium. #OrlandoPiratesVideo #MadeInSA",
        likes: 42,
        retweets: 12,
        replies: 8,
        time: "2h"
    ...
    {
        id: 2,
        username: "Lindiwe Mokoena",
        handle: "@lindim",
        avatar: "https://ui-avatars.com/api/?name=Lindiwe+Mokoena&background=1DA1F2&color=fff&size=48",
        text: "Working on the Orlando Pirates media drop to showcase local creativity. #OrlandoPiratesVideo #SAcreatives",
        likes: 28,
        retweets: 7,
        replies: 5,
        time: "4h"
    ...
    {
        id: 3,
        username: "Mzansi Media",
        handle: "@mzansimedia",
        avatar: "https://ui-avatars.com/api/?name=Mzansi+Media&background=1DA1F2&color=fff&size=48",
        text: "The Orlando Pirates video of Relebohile Mofokeng is trending all over South Africa. What's next for the South African sensation? #OrlandoPiratesVideo #Mzansi",
        likes: 156,
        retweets: 45,
        replies: 23,
        time: "6h"
    },
    {
        ...
        handle: "@aneleD",
        avatar: "https://ui-avatars.com/api/?name=Anele+Dlamini&background=1DA1F2&color=fff&size=48",
        text: "Just watched the Orlando Pirates clip of Rele what an emotional moment! #OrlandoPirates #Onceandalways #Relebohile Mofokeng",
        likes: 89,
        retweets: 23,
        replies: 12,
        time: "8h"
    ...
    {
        id: 5,
        username: "Mandla Nkosi",
        handle: "@MandlaNkosi",
        avatar: "https://ui-avatars.com/api/?name=Mandla+Nkosi&background=1DA1F2&color=fff&size=48",
        text: "Go and represent us well well bro. I've never been happy for the boy! #Ezimnyama ngenkani #OrlandoPirates",
        likes: 234,
        retweets: 89,
        replies: 34,
        time: "12h"
    },
    {
        ...
        handle: "@thabond",
        avatar: "https://ui-avatars.com/api/?name=Thabo+Ndlovu&background=1DA1F2&color=fff&size=48",
        text: "So happy for our boy he is our certified legend. #OrlandoPirates #Once and always",
        likes: 312,
        retweets: 156,
        replies: 45,
        time: "14h"
